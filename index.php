...
<!-- ========== Slider Parallax ========== -->
<header class="main-slider v-dark-head-mobile has-horizontal  active-nav-slider dsn-webgl has-paginate"
    data-dsn-option="{&quot;direction&quot;:&quot;horizontal&quot;,&quot;allowTouchMove&quot;:true,&quot;watchSlidesProgress&quot;:true,&quot;grabCursor&quot;:true,&quot;mousewheel&quot;:false}"
    data-dsn-webgl="{&quot;displacement&quot;:&quot;https:\/\/izhtech.com\/wp-content\/plugins\/blackdsn-helper-plugin\/assets\/img\/displacement\/8.jpg&quot;,&quot;intensity&quot;:-2,&quot;speed_in&quot;:1.2,&quot;speed_out&quot;:1.2}">
                ...
                <div class="swiper-wrapper">
                    <div class="slide-item swiper-slide over-hidden">
                        <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="4">
                            <img width="150" height="202" src="./assets/img/Banner/banner-img-1.jpg"
                                class="cover-bg-img dsn-swiper-parallax-transform wp-post-image" alt=""
                                decoding="async" loading="lazy" data-dsn-position="50% 50%"
                                data-dsn-src="./assets/img/Banner/banner-img-1.jpg"
                                data-dsn-srcset="./assets/img/Banner/banner-img-1.jpg 1400w, ./assets/img/Banner/banner-img-1.jpg 223w, ./assets/img/Banner/banner-img-1.jpg 300w"
                                srcset="./assets/img/Banner/banner-img-1.jpg 150w, ./assets/img/Banner/banner-img-1.jpg 300w, ./assets/img/Banner/banner-img-1.jpg 1400w"
                                sizes="(max-width: 1400px) 100vw, 1400px" />
                        </div>
                        <div class="slide-content p-absolute">

                            <h2 class="title has-box-mod p-relative effect-ajax" data-dsn-split="chars"
                    ...
                    <div class="slide-item swiper-slide over-hidden">
                        <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="3">
                            <img class="cover-bg-img dsn-swiper-parallax-transform"
                                src="./assets/img/Banner/banner-img-2.jpg" alt=""
                    ...
                    <div class="slide-item swiper-slide over-hidden">
                        <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="2">
                            <img loading="lazy" width="150" height="84"
                                src="./assets/img/Banner/banner-img-4.jpg"
                                class="cover-bg-img dsn-swiper-parallax-transform wp-post-image" alt=""
                                decoding="async" data-dsn-position="50% 50%"
                                data-dsn-src="./assets/img/Banner/banner-img-4.jpg"
                                data-dsn-srcset="./assets/img/Banner/banner-img-4.jpg 1920w, ./assets/img/Banner/banner-img-4.jpg 300w, ./assets/img/Banner/banner-img-4.jpg 880w"
                                srcset="./assets/img/Banner/banner-img-4.jpg 150w, ./assets/img/Banner/banner-img-4.jpg 300w, ./assets/img/Banner/banner-img-4.jpg 1024w, ./assets/img/Banner/banner-img-4.jpg 880w, ./assets/img/Banner/banner-img-4.jpg 1920w"
                        ...
                        <div class="slide-content p-absolute">
                            ...
                            <p class="description swiper-animate-head max-w570 mt-20">
                                Looking to enhance your online presence? We offer top-notch digital
                                growth services to help your your brand stand out in the digital world.
                            </p>
                        </div>
                    </div>
                    <div class="slide-item swiper-slide over-hidden">
                        <div class="image-bg cover-bg w-100 h-100 before-z-index" data-overlay="2">
                            <img width="1920" height="1080" src="./assets/img/Banner/banner-img-3 .jpg"
                                class="cover-bg-img dsn-swiper-parallax-transform wp-post-image" alt=""
                                decoding="async" loading="lazy" data-dsn-position="50% 50%"
                                data-dsn-src="./assets/img/Banner/banner-img-3 .jpg"
                                data-dsn-srcset="./assets/img/Banner/banner-img-3 .jpg 1920w, ./assets/img/Banner/banner-img-3 .jpg 300w, ./assets/img/Banner/banner-img-3 .jpg 416w"
                                srcset="./assets/img/Banner/banner-img-3 .jpg 1920w, ./assets/img/Banner/banner-img-3 .jpg 300w, ./assets/img/Banner/banner-img-3 .jpg 416w"
                                sizes="(max-width: 1920px) 100vw, 1920px" />
                        </div>
                        <div class="slide-content p-absolute">
                            <h2 class="title has-box-mod p-relative effect-ajax" data-dsn-split="chars"
                            ...
                            <p class="description swiper-animate-head max-w570 mt-20">
                                Bring your software vision to life with our top-notch development team
                                that creates tailored solutions to meet your unique business needs and
                                objectives.
                            </p>
                        </div>
                    </div>
    ...
    <div class="dsn-swiper-paginate">
        <div class="swiper-pagination pointer-large dsn-swiper-circle mr-30 ml-30 heading-color"></div>
    </div>

    <div class="control-nav w-100  d-flex dsn-container  align-items-center justify-content-between">
        <div class="prev-paginate pointer-large dsn-paginate-arrow box-shadow"></div>


        <div class="dsn-pagination p-relative d-flex align-items-end">
            <span class="slider-current-index h2">01</span>
            <span class="sm-title-block">/ </span><span class="total sm-title-block"> 04</span>
        </div>

        <div class="next-paginate pointer-large dsn-paginate-arrow box-shadow"></div>
            ...
            <div class="service-item p-relative grid-item border-left dsn-icon-theme-color">
                <div class="service-item-inner align-items-center number-item h-100">
                    ...
                    <div class="service-content p-relative">
                        ...
                        <div class="service_description mt-10 max-w570 dsn-auto">
                            To make life simpler by providing complex tech in a
                            simpler way.
                        </div>
                    </div>
                </div>
            ...
            <div class="service-item p-relative border-left grid-item">
                <div class="service-item-inner align-items-center number-item h-100">
                    ...
                    <div class="service-content p-relative">
                        ...
                        <div class="service_description mt-10 max-w570 dsn-auto">
                            Equally disciplined and relish work ethic.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-grid grid-md-2">
                <div class="box-info">
                    ...
                    <div class="d-grid grid-half-1 align-items-center mt-10">
                        <div class="dsn-def-btn dsn-hover-icon pointer-large">
                            <a class="dsn-btn background-main effect-ajax has-icon-left"
                                href="./about-us.html" data-dsn-text="About Us" data-dsn="parallax">
                        ...
                        <div class="p-large text-right">
                            <p class="max-w350">
                                Our company specializes in offering a wide range of
                                digital services that enable businesses to expand their
                                online presence and achieve their growth objectives. We
                                prioritize creating designs that are tailored to meet
                ...
                <div class="box-img">
                    <img decoding="async" class="cover-bg-img" src="./assets/img/About/About-img-3.jpg"
                        title="" alt="" />
                </div>
            </div>
            <div class="p-relative box-img-bottom hv-50">
                <img class="cover-bg-img" decoding="async" src="./assets/img/About/About-new-2.jpg" title=""
                    alt="" />
            </div>
        </div>
    </section>
    ...
    <div class="container section-margin">
        <div class="section-title mb-70 d-grid grid-md-2">
            ...
            <div class="dsn-def-btn dsn-icon-heading-color align-self-end justify-self-end">
                <a class="dsn-btn dsn-border border-color-default background-section effect-ajax effect-ajax move-circle has-icon-left pointer-large"
                    href="./service.html" data-dsn-text="Service" data-dsn="parallax">
                    ...
                    <div class="service-item-inner border-style number-item h-100">
                        ...
                        <div class="service-content p-relative">
                            ...
                            <div class="service_description mt-20 max-w570 dsn-auto">
                                <p>
                                    Craft one-of-a kind brand person, captivate your
                                    audience with compelling communication, and faster
                                    unbreakable cusomer loyality - all through the power
                                    of branding.
                                </p>
                            </div>
                        </div>
                ...
                <div class="dsn-up service-item p-relative grid-item style-box">
                    <div class="service-item-inner border-style number-item h-100">
                        ...
                        <div class="service-content p-relative">
                            ...
                            <div class="service_description mt-20 max-w570 dsn-auto">
                                <p>
                                    Propel your brand with results-oriented, winsome
                                    content for your website, email campaigns, social
                                    media channels and paid apportionment
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="d-grid grid-lg-2 d-grid-no-space">
            <div class="left-box-image mb-section">
                <div class="box-img w-100"
                    ...
                    <div class="img-box-parallax h-v-80 before-z-index w-100" data-overlay="1">
                        <img class="cover-bg-img" src="./assets/img/Index/index-3.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div class="box-info background-section p-80 mt-section">
                ...
                <ul class="d-grid dsn-list mt-20" data-dsn-gap="10px 15px">
                    ...
                    <li class="list-item d-flex align-items-center background-main">
                        <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                        <p class="dsn-heading-title heading-color">Design</p>
                    </li>
                    <p class="mt-20">
                        We embark aggregating artistic ambiance to utility by
                        creating a design that magnifies focal points
                    </p>
                    <li class="list-item d-flex align-items-center background-main">
                        <span class="dsn-icon mr-15"><i class="fas fa-check" aria-hidden="true"></i></span>
                        <p class="dsn-heading-title heading-color">Development</p>
                    </li>
                    <p class="mt-20">
                        We ensure simplicity and elegance as the pivotal essences of
                        any productive web design for the developers to grease the
                        wheels for customer based designs.
                    </p>
                </ul>
            </div>
        </div>
    </div>
    <!-- ========== End Service Process Section One ========== -->
        ...
        <div class="d-grid grid-md-4 grid-sm-2 dsn-brand">
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/reactjs.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/android.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/aws-logo.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/mongodb.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/nodejs.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/sqlf.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/sql-1.png" alt="">
                </div>
            </div>
            <div class="brand-item border-style">
                <div class="brand-item-inner  over-hidden p-relative ">
                    <img src="./assets/img/brand/microsoft.png" alt="">
                </div>
            </div>
