                        ...
                        <div class="content p-relative ">
                            <div class="intro-project w-100">
                                <div class="intro-title ">
                                    ...
                                    <div id="hero_title" class="mt-20"><a href="./about-us.html">
                                            <h1 class="title text-upper">About us</h1>
                                        </a>
                                    </div>
                                    <p class="mt-20 max-w570">
                                        Our company specializes in offering a wide range of digital services that
                                        enable businesses to expand their online presence and achieve their growth
                                        objectives. We prioritize creating designs that are tailored to meet the
...
<div class="box-under-bottom-img mb-section">
    <div class="img-box-parallax before-z-index dsn-animate dsn-effect-down h-v-80"
        ...
        <img class="has-bigger-scale cover-bg-img has-direction" src='./assets/img/About/90439.jpg'
            alt='' />
    </div>
    <div class="p-relative content container background-theme box-padding border-rdu text-center">
        <h3 class="title-block-lg text-upper">WHAT DO WE DO?
        </h3>
        <p class="dsn-heading-title mt-20 max-w750">
            We excel in delivering top-notch web design, web & mobile applications, and digital
            marketing
            solutions that are customized to suit your business's distinct requirements. Our team of
            highly
            skilled and experienced professionals utilizes the latest technologies and methodologies to
    ...
    <div class="section-title mb-70 d-grid grid-md-2 ">
        ...
        <div class="dsn-def-btn dsn-icon-heading-color align-self-end justify-self-end">
            <a class="dsn-btn dsn-border border-color-default  background-section effect-ajax effect-ajax  move-circle has-icon-left"
                href="./service.html" data-dsn-text="Service" data-dsn="parallax"> <span
                    ...
                    <div class="service-content p-relative">
                        ...
                        <div class="service_description mt-20 max-w570 dsn-auto">
                            <p>
                                ...
                                website, email campaigns, social media channels and paid apportionment
                            </p>
                        </div>
                    </div>
                </div>
