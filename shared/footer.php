                            ...
                            <div class="d-grid grid-lg-4 grid-md-2 ">
                                        ...
                                        <div class="main-logo">
                                            <a href="./index.php" data-dsn-text="Blackdsn"
                                                ...
                                                <img class="custom-logo logo-dark"
                                                    src="./assets/img/Logo/Logo_-_black.png" alt="Blackdsn" />
                                            </a>
                                        </div>
                                    </div>
                                    <ul class="dsn-socials box-social mt-20 dsn-icon-heading-color">
                                        <li><a href="https://www.linkedin.com/company/izh-tech/" target="_blank"
                                                rel="nofollow" class="init-color move-circle border-color-default"
                                                data-dsn="parallax"><span class="dsn-icon"><i
                                                        class="fab fa-linkedin-in"></i></span><span>LN</span></a>
                                        </li>

                                        <li><a href="https://twitter.com/izhtech" target="_blank" rel="nofollow"
                                                class="init-color move-circle border-color-default"
                                                data-dsn="parallax"><span class="dsn-icon"><i
                                                        class="fab fa-twitter"></i></span><span>TW</span></a>
                                        </li>

                                        <li><a href="https://www.facebook.com/profile.php?id=100091657835111"
                                        ...
                                        <li><a href="https://www.instagram.com/izh_tech/" target="_blank" rel="nofollow"
                                                class="init-color move-circle border-color-default"
                                                data-dsn="parallax"><span class="dsn-icon"><i
                                ...
                                <div class="grid-col-3">
                                    ...
                                    <div class="col-contact">
                                        <p><strong>M</strong> :+65 89269693 </p>
                                        <p class="over-hidden mt-10">
                                            <strong>E:</strong> <a class="link-hover" href="#"
                                                data-hover-text="admin@izhtech.com">info@izhtech.com</a>
                                        </p>
                                    </div>
                                ...
                                <div class="grid-col-4">
                                    ...
                                    <div class="col-address">
                                        <p>
                                            Flora Drive,<br>Singapore 506889
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="social-side d-flex align-items-center flex-column justify-content-center">
            ...
            <ul class="socials d-flex flex-column-reverse">
                <li style="--dsn-index-animate : 0;">
                    <a href="https://www.linkedin.com/company/izh-tech/" target="_blank" rel="nofollow">
                        <i class="fab fa-linkedin-in" aria-hidden="true"></i><span>Linkedin</span>
                    </a>
                </li>

                <li style="--dsn-index-animate : 1;">
                    <a href="https://twitter.com/izhtech" target="_blank" rel="nofollow">
                        <i class="fab fa-twitter" aria-hidden="true"></i><span>Twitter</span>
                    </a>
                </li>

                <li style="--dsn-index-animate : 2;">
                    <a href="https://www.facebook.com/profile.php?id=100091657835111" target="_blank" rel="nofollow">
                        <i class="fab fa-facebook-f" aria-hidden="true"></i> <span>Facebook</span>
                    </a>
                </li>
                <li style="--dsn-index-animate : 3;">
                    <a href="https://www.instagram.com/izh_tech/" target="_blank" rel="nofollow">
